...
public class CaptureHelper extends ScreenRecorder {
    ...
    protected File createMovieFile(Format fileFormat) throws IOException {
        ...
        return new File(movieFolder, name + "_" + SystemHelper.getDateTimeFormatted() + "." + Registry.getInstance().getExtension(fileFormat));
    }
    ...
    public static void startRecord(String VideoRecordName) {
        ...
        File file = new File(SystemHelper.getCurrentDir() + PropertiesHelper.getValue("VideoRecord_path"));
        ...
        try {
            screenRecorder = new CaptureHelper(gc, captureSize, new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_AVI), new Format(MediaTypeKey, MediaType.VIDEO, EncodingKey, ENCODING_AVI_TECHSMITH_SCREEN_CAPTURE, CompressorNameKey, ENCODING_AVI_TECHSMITH_SCREEN_CAPTURE, DepthKey, 24, FrameRateKey, Rational.valueOf(15), QualityKey, 1.0f, KeyFrameIntervalKey, 15 * 60), new Format(MediaTypeKey, MediaType.VIDEO, EncodingKey, "black", FrameRateKey, Rational.valueOf(30)), null, file, VideoRecordName);
